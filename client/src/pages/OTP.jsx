  ...
  <div className="flex flex-col justify-center md:flex-row h-screen">
    ...
    <div classNAme="max-w-sm w-full">
      ...
      <form onSubmit={handleOtpVerification}> 
        <div className="mb-4">
          ...
          placeholder="OTP" className="w-full px-4 py-3 border border-black rounded-md focus:outline-none"/>
        </div>
    ...
    <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tl-[80px] rounded-bl-[80px]">
      <div className="text-center h-[400px]">
        ...
        <Link to={"/register"} className="border-2 mt-5 border-white px-8 w-full font-semibold bg-black text-white py-2 rounded-lg hover:bg-white hover:text-white transition">SIGN UP</Link>
      </div>
    </div>
  </div>
  </>;
